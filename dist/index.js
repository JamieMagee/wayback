...
var serialOrdered = __webpack_require__(940);
...
const form_data_1 = __importDefault(__webpack_require__(419));
class WayBack {
    constructor(url) {
        this.baseWaybackUrl = 'https://web.archive.org/save/';
        this.statusGuidRegex = /watchJob\("(?<guid>[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12})/;
        this.url = url;
    }
    async save() {
        const requestUrl = `${this.baseWaybackUrl}${this.url}`;
        ...
        const match = this.statusGuidRegex.exec(res.data);
        if (match) {
            const guid = match.groups.guid;
            await this.getStatus(guid);
        }
    }
    async getStatus(guid) {
        const status = (await axios_1.default.get(`${this.baseWaybackUrl}status/${guid}`)).data;
        console.log(status);
    }
}
...
const wayback_1 = __importDefault(__webpack_require__(82));
async function run() {
    try {
...
Object.defineProperty(exports, "__esModule", { value: true });
const runner_1 = __importDefault(__webpack_require__(184));
...
var debug = __webpack_require__(727);
...
var iterate    = __webpack_require__(740)
  , initState  = __webpack_require__(906)
  , terminator = __webpack_require__(503)
  ;
...
var CombinedStream = __webpack_require__(950);
var util = __webpack_require__(669);
...
var mime = __webpack_require__(693);
var asynckit = __webpack_require__(571);
var populate = __webpack_require__(863);
...
var abort = __webpack_require__(167)
  , async = __webpack_require__(201)
  ;
...
module.exports =
{
  parallel      : __webpack_require__(417),
  serial        : __webpack_require__(10),
  serialOrdered : __webpack_require__(940)
};
...
var util = __webpack_require__(669);
var Stream = __webpack_require__(413).Stream;
var DelayedStream = __webpack_require__(283);
